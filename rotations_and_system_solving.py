...
# ------------------------------------------------------------------
def main():
    w = np.loadtxt(input("Enter the name of the file in this directory with the matrix W (W*H=A): "))
    p = w.shape[1]
    a = np.loadtxt(input("Enter the name of the file in this directory with the matrix A (W*H=A): "))
    n = a.shape[0]
